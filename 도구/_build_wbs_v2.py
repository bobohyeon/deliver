...
TASKS = [
    ...
    ("1", "설계·합의", "", "", "", "", "", "", "", False),
    ("1.1", "", "범위·컨셉 확정", "", "", "", "", "", "", False),
    ("1.1.1", "", "", "기능명세서 136건 검토·합의", "전 영역", ALL, "2026-08-10", "2026-08-11", "기능명세서 확정", False),
    ("1.1.2", "", "", "폐기 설계 6건 공유·승인 (폐기 ID)", "ANL-04·ANL-13·AMT-04·AMT-05·AMT-10·VIS-08", B, "2026-08-10", "2026-08-10", "폐기 기록", False),
    ("1.1.3", "", "", "P1 58건 내부 우선순위 재정렬", "", ALL, "2026-08-11", "2026-08-11", "우선순위 확정", False),
    ("1.2", "", "설계 확정", "", "", "", "", "", "", False),
    ...
    ("3", "협업 기반", "", "", "", "", "", "", "", False),
    ("3.1", "", "프로젝트·권한", "", "", "", "", "", "", False),
    ("3.1.1", "", "", "프로젝트 CRUD · 보관 (API 6~10)", "PRJ-01~05", J, "2026-08-24", "2026-08-25", "코드", False),
    ("3.1.2", "", "", "멤버 초대·역할 관리 (API 11~14)", "PRJ-06·PRJ-07", J, "2026-08-25", "2026-08-26", "코드", False),
    ("3.1.3", "", "", "리포지토리 계층 스코프 강제", "PRJ-08", J, "2026-08-26", "2026-08-27", "코드 + 침투 테스트", True),
    ("3.2", "", "비동기·저장소", "", "", "", "", "", "", False),
    ("3.2.1", "", "", "업로드 202 전환 · 워커 파이프라인 (API 15)", "DOC-06", J, "2026-08-24", "2026-08-26", "코드", False),
    ("3.2.2", "", "", "파일 저장소 S3·MinIO 이전", "DOC-14", J, "2026-08-27", "2026-08-28", "코드", False),
    ("3.3", "", "태스크", "", "", "", "", "", "", False),
    ("3.3.1", "", "", "tasks 스키마 확장 (completed_at·출처 FK·CHECK)", "TSK-01", B, "2026-08-24", "2026-08-24", "마이그레이션", False),
    ("3.3.2", "", "", "태스크 CRUD · 칸반 보드 · 담당자·기한 (API 38~41)", "TSK-01·TSK-02·TSK-06", J, "2026-08-27", "2026-09-01", "코드", False),
    ("3.3.3", "", "", "AI 생성 배지 · 필터 · 출처 표시", "TSK-04·TSK-05", J, "2026-09-01", "2026-09-02", "코드", False),
    ...
    # ── RAG 검색·근거 (신규 영역 L)
    ("3.7", "", "검색·근거 (RAG)", "", "", "", "", "", "", False),
    ("3.7.1", "", "", "청킹 · 임베딩 · 벡터 인덱스 (리비전 0009)", "RAG-01·RAG-02·RAG-03", B, "2026-08-31", "2026-09-02", "코드·마이그레이션", False),
    ("3.7.2", "", "", "의미 검색 · 근거 스니펫 · 컨텍스트 조립", "RAG-04·RAG-07·RAG-08", B, "2026-09-02", "2026-09-04", "코드", False),
    ("3.7.3", "", "", "검수 확정 시 재임베딩 · 단가 선례 검색", "RAG-09·RAG-12", B, "2026-09-03", "2026-09-04", "코드", False),
    ("3.8", "", "금액 계산·검증", "", "", "", "", "", "", False),
    ("3.8.1", "", "", "추출 스키마 검증 · 정규화", "AMT-12·ANL-16", B, "2026-08-17", "2026-08-18", "코드·단위테스트", False),
    ("3.8.2", "", "", "단가·원가구분 컬럼 (리비전 0008)", "AMT-13", B, "2026-08-18", "2026-08-18", "마이그레이션", False),
    ("3.8.3", "", "", "비용 산출 엔진 · 계산식 표시", "AMT-14·AMT-17", B, "2026-08-19", "2026-08-21", "코드·단위테스트", False),
    ("3.8.4", "", "", "평가셋 정확도 측정 자동화", "ANL-17", B, "2026-08-20", "2026-08-21", "측정 도구", False),
]
